...
parser.add_argument('--parsedA_dir') # directory containing *_parseAposition_Ribo.txt outputs from bowtieSAM_parse_A_position_Ribo_wrapper_slurm.py
parser.add_argument('--log_dir') # log directory
parser.add_argument('--script_path', default='/home/adelexu/research/riboprof/riboprof/scripts/UTR_CDS_reads_count_submit.sh') # path to UTR_CDS_reads_count_submit.sh
