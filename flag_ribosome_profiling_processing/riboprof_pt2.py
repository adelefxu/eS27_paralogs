# pipeline part 2
#
# automates the following stages of processing:
# - stage 3: in-line barcodes and UMIs extracted
# - stage 4: reads filtered by quality
# - stage 5: reads removed if aligning to rRNA, tRNA, snRNA
# - stage 6: reads aligned to canonical transcripts
# - stage 7: reads sorted
# - stage 8: reads deduplicated
# - stage 9: reads re-sorted after deduplication
#
